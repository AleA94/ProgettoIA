...
public class HeapPriorityQueue<V> implements PriorityQueue<V> {
	...
	/**
	 * Costruttore della coda con priorità heap : array di elemConPrio, di
	 * lunghezza n+1; indiceUltimo : posizione dell'ultimo elemento, con
	 * priorità massima, inizializzato a 0. position : tabella di hash che
	...
	public void printHeap() {
		for (int i = 0; i < indiceUltimo; i++) {
			position.toString();
			System.out.println("Elemento: " + heap[i].element + " , Priorità: "
